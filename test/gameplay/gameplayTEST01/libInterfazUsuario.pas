...
interface
		...
		procedure intro(); // imprime la portada del juegoprocedure jugadorGano(); // imprime la pantalla de juego terminado-Victoria
		...
		procedure presentarColor(comp: conjCompletadas; errores: integer); // presenta las opciones de colores
		procedure presentarPuntuacion(puntaje, error: integer); // presenta el puntaje final de cada partida
		procedure presentarPregunta(p: tipoPreguntas; errores: integer); // presenta la pregunta actual al jugador
